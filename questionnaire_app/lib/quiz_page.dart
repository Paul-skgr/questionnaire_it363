      ...
      switch (type) {
        ...
        case "map-q":
          setState(() {
            ...
            if (correctCoordinatesCleaned.length ==
                    selectedCoordinates.length &&
                (double.parse(correctCoordinatesCleaned[0]) -
                            double.parse(selectedCoordinates[0]))
                        .abs() <=
                    9.0 &&
                (double.parse(correctCoordinatesCleaned[1]) -
                            double.parse(selectedCoordinates[1]))
                        .abs() <=
                    9.0) {
              _difficulty++;
              _correctAnswersCount++;
